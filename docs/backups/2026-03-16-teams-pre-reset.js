...
// Updated: 2026-03-15 — Tharivol obtido (S1 Prince Chest). Time Dauntless atualizado.
...
window.DATA_TEAMS = [
  ...
  // ─── GRAVE OF VENOM (AllClash rewrite) ───
  {
    ...
    notes: "Baseado em AllClash Mid-Range com Nastjenka no lugar de Rowena (DPS upgrade). THARIVOL OBTIDO 15/Mar — AllClash Endgame agora disponivel para teste!",
    variants: [
      {
        name: "AllClash Endgame S1",
        change: "Eurion + Ivellios + Tharivol + Nastjenka + Felosia",
        status: "untested",
        notes: "Time ideal do AllClash. TODOS HEROIS DISPONIVEIS (Tharivol obtido 15/Mar). PRIORIDADE TESTE."
      },
      {
    ...
    variants: [
      {
        ...
        status: "reference",
        notes: "Time ideal do AllClash. Tharivol obtido (15/Mar). Ainda falta Zeffi."
      },
      {
  ...
  // ─── GRAVE OF ROT (AllClash rewrite) ───
  {
    ...
    variants: [
      ...
      },
      {
        ...
        status: "untested",
        notes: "Time ideal do AllClash. TODOS HEROIS DISPONIVEIS (Tharivol obtido 15/Mar). SEM Torrin — testar se Invisibility counter e necessario. PRIORIDADE TESTE."
      },
      {
        name: "AllClash Mid-Range",
  ...
  // ─── TEMPORAL VORTEX (Dauntless Aggro — CAMPEAO 31.3M) ───
  {
    ...
    variants: [
      ...
      {
        name: "Tharivol no lugar de Garett (NOVO)",
        change: "Garett -> Tharivol",
        status: "untested",
        bonds: "5 Resplendence | 4 Dauntless | 1 Support",
        notes: "Tharivol ATK Speed stacking → Nastjenka Crit Rate. Ignora Immortality. Garett captain redundante. TESTAR vs 31.3M baseline."
      },
      {
  ...
  // ─── ANCIENT BATTLEFIELD (AllClash rewrite) ───
  {
    ...
    notes: "Baseado em AllClash Endgame (Tharivol+Nastjenka+Vinyara+Acilia+Felosia) mas com estratégia Immortal testada. THARIVOL OBTIDO 15/Mar — AllClash Endgame agora disponivel! Voresh Buff Prohibition é ESSENCIAL neste boss. Lv8 CLEAR confirmado.",
    variants: [
      {
        name: "AllClash Endgame S1",
        change: "Tharivol + Nastjenka + Vinyara + Acilia + Felosia",
        status: "untested",
        notes: "Time ideal do AllClash. TODOS HEROIS DISPONIVEIS (Tharivol obtido 15/Mar). PRIORIDADE TESTE. Perde Voresh Buff Prohibition — testar se Acilia anti-debuff compensa."
      },
      {
  ...
  // ─── FROST DOMAIN (25/Fev — 4 Dauntless + Acilia, Lv18 CLEAR) ───
  {
    ...
    notes: "Lv18 CLEAR sem Torrin nem Eurion! Puro DPS race + Acilia anti-debuff. 4 Dauntless = Thundercloud chain massivo. Acilia sozinha resolve a mecanica do boss (previne debuffs = sem shields). Sem healer — mata rapido demais pra precisar. THARIVOL OBTIDO 15/Mar — testar no lugar de Garett.",
    variants: [
      {
        name: "Tharivol no lugar de Garett (NOVO)",
        change: "Garett -> Tharivol",
        status: "untested",
        notes: "Tharivol ATK Speed stacking + ignora Immortality. Garett captain redundante. Mantém 4 Dauntless + Acilia."
      },
      {
  ...
  // ─── TIME DAUNTLESS (atualizado 15/Mar — Tharivol obtido) ───
  {
    id: "time-dauntless",
    name: "Time Dauntless (Canonico — com Tharivol)",
    ...
    score: null,
    members: [
      { id: 20740, role: "DPS carry", notes: "Ult AoE + feather procs em basics aliados 10s. Captain +24% ATK" },
      ...
      { id: 20890, role: "DPS single-target", notes: "NOVO (15/Mar). Battle 300% IGNORA IMMORTALITY. Passiva ATK Speed Up (ate 15 stacks) → alimenta Crit Rate da Nastjenka. Ult multi-shot crit garantido +30% Crit Rate" },
      { id: 20420, role: "Sustain solo", notes: "Acilia. Anti-debuff + sustain AoE. Fecha 5 Resplendence" }
    ],
    bonds: "5 Resplendence (4 Lightning + 1 Radiance) | 4 Dauntless | 1 Support | Auras: +24% ATK, +30% ATK Speed",
    captain: { id: 20740, skill: "+24% ATK em todas as batalhas" },
    mechanics: {
      boss: "Multi-uso (base para G.Curse, G.Rot, H.Ruins, T.Vortex, Frost Domain)",
      perigo: "4 DPS + 1 sustain. Acilia segura sozinha na maioria do conteudo.",
      como_vencer: "Tharivol ATK Speed stacking → Nastjenka converte em Crit Rate. DA Battle 5 hits = feather procs constantes. 4 Dauntless Thundercloud. Tharivol ignora Immortality = counter tanks.",
      food: "Feast of Thunder (Lightning +5%, ATK +10%) — 4/5 Lightning + 1 Radiance"
    },
    notes: "ATUALIZADO 15/Mar: Tharivol substitui Garett. DA fica (Kui Crown + 5 basic attacks = muitos feather procs). Garett captain (+24% Crit DMG) era redundante com Nastjenka captain. Tharivol traz ATK Speed stacking (sinergia Nastjenka) + ignora Immortality. Acilia fecha 5 Resplendence.",
    variants: [
      {
        name: "Full 5 Dauntless (glass cannon)",
        change: "Acilia -> Garett (volta 5 Dauntless)",
        status: "untested",
        notes: "5 Dauntless = 50% Thundercloud. Zero sustain. So para conteudo facil/rapido."
      },
      {
        name: "Sustain hard (Felosia)",
        change: "Acilia -> Felosia",
        status: "untested",
        notes: "Felosia shield + DR. Alternativa quando Acilia nao segura."
      },
      {
        name: "Com Garett (composicao anterior)",
        change: "Tharivol -> Garett",
        status: "tested",
        notes: "Time anterior. Garett ATK +200% passiva forte mas captain redundante."
      }
    ]
  },
...
window.DATA_HERO_FREQUENCY = [
  ...
  { id: 20890, teams: 1, activities: "Time Dauntless (+ AllClash Endgame G.Venom, G.Rot, A.Battlefield pendentes teste)" }
];
