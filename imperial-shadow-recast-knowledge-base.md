...
### 2.1 Estrutura Semanal

| Semana | Bosses Disponíveis | Times Necessários | Heróis Mínimos |
|---|---|---|---|
| 1 | 2 bosses | 2 times | 10 heróis |
| 2 | 4 bosses | 4 times | 20 heróis |
| 3 | 6 bosses (todos) | 6 times | 30 heróis |
...
- **Você pode "salvar" times:** Na semana 1, salve o time com melhor resultado para reusar a composição.

### 2.3 Estratégia Geral de Alocação de Times

```
REGRA DE OURO: Use seu time MAIS FORTE contra o boss MAIS FÁCIL para maximizar dano e ranking no leaderboard.
```
...
- **Semana 1:** Foque nos 2 bosses mais fáceis. Recomendados: Thelandor e Vasska (ou Vinyara).
- **Semana 2:** Adicione 2 bosses de dificuldade média.
- **Semana 3:** Complete todos os 6 — aqui a profundidade de roster importa muito.
- Guarde bosses mais difíceis (Twitch, Tamar) para semanas posteriores quando você tiver mais experiência com as mecânicas.
...
2. Completar os desafios gera **Shadow Amethysts** (até ~60/semana, ~15 por desafio completado)
3. Ativar um desafio libera o uso de **Double Concentrates** — que dão **drop duplo** de materiais nas dungeons

### 5.2 Double Concentrates — Regras

- **Restauram diariamente** — você ganha uma quantidade fixa de double drops por dia
- **Só funcionam enquanto o desafio está ATIVO** (não completo)
- **Uma vez que o desafio é completado, o drop duplo desse desafio ENCERRA**

### 5.3 Otimização de Shadow Dungeon

```
REGRA CRÍTICA: NÃO complete os Shadow Challenges rápido demais!
Quanto mais dias o desafio ficar ativo (sem completar), mais Double Concentrates você aproveita.
```

**Estratégia recomendada:**
1. **No início da semana:** Ative os 3 Shadow Challenges
2. **Escolha dungeons que você PRECISA farmer** (gear, talentos ou recursos)
3. **Use os Double Concentrates diariamente** em cada dungeon ativa
4. **Deixe os desafios quase completando** até o final da semana — complete-os apenas perto do deadline
5. **Repita na próxima semana** com novos desafios
