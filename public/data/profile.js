...
window.DATA_PROFILE = {
  ...
  banner_progress: {
    ...
    echoing_shadow_s6: {
      status: "completo",
      date: "2026-04-09",
      type: "Echoing Shadow Summon",
      pulls: 800,
      pool: "Radiance + Lightning",
      new_legendaries: ["Lincos", "Diantha", "Aemonleyda", "Stanguem", "Orfenna", "Perkunte", "Nissa", "Bionphray", "Phaessa", "Gillian"],
      milestone_bonus: ["Lincos (100)", "Diantha (200)", "Aemonleyda (300)", "Stanguem (400)", "Orfenna (600)", "Perkunte (800)"],
      regular_legendaries: ["Stanguem", "Nissa", "Orfenna", "Tamar", "Bionphray", "Lincos", "Nissa", "Lincos", "Phaessa", "Nissa", "Nissa", "Gillian", "Aemonleyda", "Nissa", "Zeffi", "Nissa", "Donella", "Nissa"],
      inspirations: ["Nissa +6 (->6)", "Lincos +2 (->2)", "Aemonleyda +1 (->1)", "Stanguem +1 (->1)", "Orfenna +1 (->1)", "Tamar +1 (->2)", "Zeffi +1 (->1)", "Donella +1 (->3)"]
    },
    radiant_wings_s6: {
      status: "completo",
      date: "2026-04-09",
      type: "Radiant Wings Banner (Aura Exclusive)",
      pulls: 300,
      pity: 300,
      selected_hero: "Anneliesis",
      new_legendaries: ["Anneliesis"],
      legendaries: ["Gillian", "Eurion", "Journ", "Talwer", "Torrin", "Lincos", "Lincos", "Lucien", "Stanguem", "Diantha", "Anneliesis"],
      inspirations: ["Gillian +1 (->1)", "Eurion +1 (->1)", "Journ +1 (->4)", "Talwer +1 (->5)", "Torrin +1 (->2)", "Lincos +2 (->4)", "Lucien +1 (->4)", "Stanguem +1 (->2)", "Diantha +1 (->1)"]
    }
  },
  ...
  continental_challenge: {
    ...
    bosses: [
      { name: "Twitch", score: 177000000, team_id: "continental-boss-twitch-dauntless-sustain" },
      { name: "Vasska", score: 117000000, team_id: "continental-boss-vasska-ice-elite" },
      { name: "Tamar", score: 86000000, team_id: "continental-boss-tamar-full-poison" },
      { name: "Thelandor", score: 46800000, team_id: "continental-boss-thelandor-summon-army" },
      { name: "Vinyara", score: 18000000, team_id: "continental-boss-vinyara-fire-wild-brody" },
      { name: "Khrysos", score: 7600000, team_id: "continental-boss-khrysos-rally-resplendence" }
    ],
    total_score: 452400000
  },
